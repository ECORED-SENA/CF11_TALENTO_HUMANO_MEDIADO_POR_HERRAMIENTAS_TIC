  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Buenas prácticas para la documentación de un proceso organizacional
        p.mb-4 #[strong Objetivo:] Verificar el aprendizaje del paso a paso a tener en cuenta para la gestión de los documentos de un proceso.
